...
struct MarketRowView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let marketRowViewModel1 = MarketRowViewModel(item: markets!.result[0], provider: marketsListProvider)
        
        let marketRowViewModel2 = MarketRowViewModel(item: markets!.result[1], provider: marketsListProvider)
